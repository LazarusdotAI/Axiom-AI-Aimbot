...
class ConfigManager:
    ...
    def _get_config_data(self, config_instance: Config) -> Dict[str, Any]:
        ...
        return {
            ...
            'model_type': getattr(config_instance, 'model_type', 'auto'),
            'model_class_names': getattr(config_instance, 'model_class_names', []),
            ...
            'sticky_aim_enabled': getattr(config_instance, 'sticky_aim_enabled', False),
            'sticky_aim_strength': getattr(config_instance, 'sticky_aim_strength', 0.3),
