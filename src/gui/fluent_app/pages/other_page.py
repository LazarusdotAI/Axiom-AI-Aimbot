...
class OtherPage(BasePage):
    ...
    def _initWidgets(self):
        ...
        # Controller aim support toggle
        # When ON, holding the Right Trigger (RT) on any connected XInput controller
        # activates aim assist, identical to pressing a configured AimKey.
        self.controllerAimCard = SwitchSettingCard(
            FluentIcon.GAME,
            t("controller_aim_enabled"),
            t("controller_aim_enabled_desc"),
            parent=self.programGroup
        )
    ...
    def _initLayout(self):
        ...
        self.programGroup.addSettingCard(self.controllerAimCard)
    ...
    def _connectSignals(self):
        ...
        self.controllerAimCard.checkedChanged.connect(self._onControllerAimChanged)
    ...
    def _loadFromConfig(self):
        ...
        self.controllerAimCard.setChecked(
            getattr(self._config, 'controller_aim_enabled', False)
        )
    ...
    def _onControllerAimChanged(self, checked: bool):
        if self._config:
            self._config.controller_aim_enabled = checked
    ...
    def retranslateUi(self):
        ...
        self.controllerAimCard.titleLabel.setText(t("controller_aim_enabled"))
        self.controllerAimCard.contentLabel.setText(t("controller_aim_enabled_desc"))
